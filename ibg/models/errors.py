...
class ErrorRoomIsNotActive(BaseError):
    def __init__(
        self, room_id: UUID, status_code: int = 403, name: str = "ErrorRoomIsNotActive"
    ):
        self.name = name
...
class RoomNotFoundError(BaseError):
    def __init__(
        self, room_id: UUID, status_code: int = 404, name: str = "RoomNotFoundError"
    ):
        self.name = name
...
class GameNotFoundError(BaseError):
    def __init__(
        self, game_id: UUID, status_code: int = 404, name: str = "GameNotFoundError"
    ):
        self.name = name
...
class WordNotFoundErrorId(BaseError):
    def __init__(
        self, word_id: UUID, status_code: int = 404, name: str = "WordNotFoundError"
    ):
        self.name = name
...
class WordNotFoundErrorName(BaseError):
    def __init__(
        self, word: str, status_code: int = 404, name: str = "WordNotFoundError"
    ):
        self.name = name
