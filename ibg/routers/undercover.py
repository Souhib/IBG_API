...
from ibg.models.undercover import Word, WordCreate, TermPair, TermPairCreate
...
async def create_term_pair(
    *,
    ...
    return await undercover_controller.create_term_pair(
        term_pair_create.word1_id, term_pair_create.word2_id
    )
