...
@pytest.mark.asyncio
async def test_create_two_users_with_same_email_address(
...
@pytest.mark.asyncio
async def test_returns_user_with_valid_uuid(
    user_controller: UserController, faker: Faker
):
    # Arrange
    user_create = UserCreate(
...
@pytest.mark.asyncio
async def test_update_user_with_valid_input(
    user_controller: UserController, faker: Faker
):
    # Arrange
    user_create = UserCreate(
...
@pytest.mark.asyncio
async def test_update_user_with_invalid_user_id(
    user_controller: UserController, faker: Faker
):
    # Arrange
    user_update = UserUpdate(
...
@pytest.mark.asyncio
async def test_update_user_password_that_doesnt_exist(
    user_controller: UserController, faker: Faker
):
    # Arrange
    non_existent_id = faker.uuid4()
