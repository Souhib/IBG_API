...
@pytest.mark.asyncio
async def test_get_games(game_controller: GameController):
...
@pytest.mark.asyncio
async def test_create_game(game_controller: GameController):
    app, client = get_test_app()
...
@pytest.mark.asyncio
async def test_create_game_room_not_active(game_controller: GameController):
    app, client = get_test_app()
    ...
    def _mock_create_game():
        game_controller.create_game = AsyncMock(
            side_effect=ErrorRoomIsNotActive(room_id=game_data["room_id"])
        )
        return game_controller
...
@pytest.mark.asyncio
async def test_get_game_by_id(game_controller: GameController):
    app, client = get_test_app()
...
@pytest.mark.asyncio
async def test_get_game_by_id_no_result_found(game_controller: GameController):
    app, client = get_test_app()
...
@pytest.mark.asyncio
async def test_update_game(game_controller: GameController):
    app, client = get_test_app()
...
@pytest.mark.asyncio
async def test_end_game(game_controller: GameController):
    app, client = get_test_app()
...
@pytest.mark.asyncio
async def test_end_game_no_result_found(game_controller: GameController):
    app, client = get_test_app()
...
@pytest.mark.asyncio
async def test_delete_game_by_id(game_controller: GameController):
    app, client = get_test_app()
...
@pytest.mark.asyncio
async def test_delete_game_by_id_no_result_found(game_controller: GameController):
    app, client = get_test_app()
    ...
    assert delete_game_route_response.json() == {
        "message": "Couldn't find requested resource"
    }
