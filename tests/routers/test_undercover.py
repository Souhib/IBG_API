...
async def test_create_word(undercover_controller: UndercoverController, faker: Faker):
    ...
    def _mock_join_room():
        undercover_controller.create_word = AsyncMock(
            return_value=Word(id=word_id, **word_create)
        )
...
async def test_create_word_already_exists(
    ...
    def _mock_join_room():
        undercover_controller.create_word = AsyncMock(
            side_effect=WordAlreadyExistsError(word=word_create["word"])
        )
        return undercover_controller
...
async def test_get_word_by_id_not_found(
    ...
    def _mock_join_room():
        undercover_controller.get_word_by_id = AsyncMock(
            side_effect=WordNotFoundErrorId(word_id=word_id)
        )
        return undercover_controller
...
async def test_get_word_by_word_not_found(
    ...
    def _mock_join_room():
        undercover_controller.get_word_by_word = AsyncMock(
            side_effect=WordNotFoundErrorId(word_id=word)
        )
        return undercover_controller
...
async def test_get_all_term_pairs(
    ...
    def _mock_join_room():
        undercover_controller.get_term_pairs = AsyncMock(
            return_value=[term_pair_1, term_pair_2]
        )
        return undercover_controller
