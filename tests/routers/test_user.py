...
from ibg.models.errors import UserAlreadyExistsError
from ibg.models.models import User
from tests.conftest import get_test_app


@pytest.mark.asyncio
async def test_get_user_by_id(user_controller: UserController):
...
@pytest.mark.asyncio
async def test_get_user_by_id_raise_no_result_found(user_controller: UserController):
    app, client = get_test_app()
    _id = uuid.uuid4()
...
@pytest.mark.asyncio
async def test_get_users(user_controller: UserController):
    app, client = get_test_app()
...
@pytest.mark.asyncio
async def test_create_user_user_already_exists(user_controller: UserController):
    app, client = get_test_app()
...
@pytest.mark.asyncio
async def test_create_user_invalid_username(user_controller: UserController):
    app, client = get_test_app()
...
@pytest.mark.asyncio
async def test_create_user_bad_country(user_controller: UserController):
    app, client = get_test_app()
...
@pytest.mark.asyncio
async def test_update_user_by_id(user_controller: UserController):
    app, client = get_test_app()
    _id = uuid.uuid4()
...
@pytest.mark.asyncio
async def test_update_user_by_id_no_result_found_error(user_controller: UserController):
    app, client = get_test_app()
    _id = uuid.uuid4()
...
@pytest.mark.asyncio
async def test_delete_user_by_id(user_controller: UserController):
    app, client = get_test_app()
    _id = uuid.uuid4()
...
@pytest.mark.asyncio
async def test_delete_user_by_id_no_result_found(user_controller: UserController):
    app, client = get_test_app()
    _id = uuid.uuid4()
...
@pytest.mark.asyncio
async def test_update_user_password(user_controller: UserController):
    app, client = get_test_app()
    _id = uuid.uuid4()
    ...
    update_user_password_route_response = client.patch(
        f"/users/{_id}/password", json=password_data
    )
